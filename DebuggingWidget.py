...
class Ui_Debugging_menu_screen(object):
    def setupUi(self, Debugging_menu_screen):
        ...
        self.pushButton = QtWidgets.QPushButton(Debugging_menu_screen)
        self.pushButton.setGeometry(QtCore.QRect(20, 20, 61, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
    ...
    def retranslateUi(self, Debugging_menu_screen):
        ...
        self.pushButton.setText(_translate("Debugging_menu_screen", "Back"))
